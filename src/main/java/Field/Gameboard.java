...
public class Gameboard {
    ...
    public Gameboard() {
        ...
        boardArray[1] = new FieldStreet("Rødovrevej", "1200 kr.", 'a', false, 1200, new int[]{50, 250, 750, 2250, 4000, 6000}, 1000, null , 2);
        boardArray[2] = new FieldChanceCard("Prøv lykken");
        boardArray[3] = new FieldStreet("Hvidovrevej", "1200  kr.", 'a', false, 1200, new int[]{50, 250, 750, 2250, 4000, 6000}, 1000, null , 2);
        boardArray[4] = new IncomeTax("Indkomstskat");
        boardArray[5] = new FieldShips("Helsingør-Helsingborg","4000 kr.", 4000,false,null,'i');
        boardArray[6] = new FieldStreet("Roskildevej", "2000 kr.", 'b', false, 2000, new int[]{100, 600, 1800, 5400, 8000, 11000}, 1000, null , 3);
        boardArray[7] = new FieldChanceCard("Prøv lykken");
        boardArray[8] = new FieldStreet("Valby Langgade", "2000 kr.", 'b', false, 2000, new int[]{100, 600, 1800, 5400, 8000, 11000}, 1000, null , 3);
        boardArray[9] = new FieldStreet("Allégade", "2400 kr.", 'b', false, 2400, new int[]{150, 800, 2000, 6000, 9000, 12000}, 1000, null , 3);
        boardArray[10] = new FieldBlank("Fængsel");
        boardArray[11] = new FieldStreet("Frederiksberg Allé", "2800 kr.", 'c', false, 2800, new int[]{200, 1000, 3000, 9000, 12500, 15000}, 2000, null , 3);
        boardArray[12] = new FieldBrewery("Tuborg", 3000, false,null,'j');
        boardArray[13] = new FieldStreet("Bülowsvej", "2800 kr.", 'c', false, 2800, new int[]{200, 1000, 3000, 9000, 12500, 15000}, 2000, null , 3);
        boardArray[14] = new FieldStreet("Gl. Kongevej", "3200 kr.", 'c', false, 3200, new int[]{250, 1250, 3750, 10000, 14000, 18000}, 2000, null , 3);
        boardArray[15] = new FieldShips("Mols-Linien", "4000 kr.",4000,false,null,'i');
        ...
        boardArray[23] = new FieldStreet("Østerbrogade", "4400 kr.", 'e', false, 4400, new int[]{350, 1800, 5000, 14000, 17500, 21000}, 3000, null , 3);
        boardArray[24] = new FieldStreet("Grønningen", "4800 kr.", 'e', false, 4800, new int[]{400, 2000, 6000, 15000, 18500, 22000}, 3000, null , 3);
        boardArray[25] = new FieldShips("Gedser-Rostock","4000 kr.", 4000,false,null,'i');
        boardArray[26] = new FieldStreet("Bredgade", "5200 kr.", 'f', false, 5200, new int[]{450, 2200, 6600, 16000, 19500, 23000}, 3000, null , 3);
        boardArray[27] = new FieldStreet("Kgs. Nytorv", "5200 kr.", 'f', false, 5200, new int[]{450, 2200, 6600, 16000, 19500, 23000}, 3000, null , 3);
    ...
    public int getPositionNamedField(String fieldName){
        int position = -1; //
        for (int i = 0; i < boardArray.length; i++) {
            if (fieldName.equals(boardArray[i].getPropertyName()) || fieldName.equals(boardArray[i].getSpecialFieldName())) {
