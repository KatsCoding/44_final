...
public class DiceCup {
    ...
    public void roll(){
        ...
        String stringSelection = game.getGui().getUserSelection("Hvad vil du gerne rulle?", "3", "4","5", "6", "7",
                "8", "9", "10", "11", "02 DOBBELT", "04 DOBBELT", "06 DOBBELT", "08 DOBBELT", "10 DOBBELT", "12 DOBBELT");
        int selection = 0;
