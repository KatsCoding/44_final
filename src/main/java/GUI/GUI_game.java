...
public class GUI_game {
    ...
    public static  GUI_Field[] makeGUIFields(){//make GUI board with the data from Gameboard
        ...
        gui_fields[26] = new GUI_Street(gameboard.getArray()[26].getPropertyName(),gameboard.getArray()[26].getDisplayPrice() ,"" , gameboard.getArray()[26].getDisplayPrice(),  new Color(255, 255, 255), Color.WHITE);
        gui_fields[27] = new GUI_Street(gameboard.getArray()[27].getPropertyName(),gameboard.getArray()[27].getDisplayPrice() ,"" , gameboard.getArray()[27].getDisplayPrice(),  new Color(255, 255, 255), Color.WHITE);
        gui_fields[28] = new GUI_Brewery("default","" ,"" , "", "" , Color.WHITE,Color.WHITE);
        gui_fields[29] = new GUI_Street(gameboard.getArray()[29].getPropertyName(),gameboard.getArray()[29].getDisplayPrice() ,"" , gameboard.getArray()[29].getDisplayPrice(),  new Color(255, 255, 255), Color.WHITE);
