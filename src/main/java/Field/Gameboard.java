...
public class Gameboard {
    ...
    public Gameboard() {/*
        ...
        boardArray[27] = new FieldStreet("Kgs. Nytorv", "5200", 'f', false, 5200, 5600, 450, 2200, 6600, 16000, 19500, 23000, 3000, null , 3);
        ...
        boardArray[32] = new FieldStreet("Vimmelskaftet", "6000", 'g', false, 550, 2600, 7800, 18000, 22000, 25000,4000, null , 3);
        ...
        boardArray[39] = new FieldStreet("Rådhuspladsen", "8000", 'h', false, 8000, 1000, 40000, 12000, 28000, 34000, 40000, null , 2);
    */
    }
}
