...
public class GUI_game {
    ...
    public static  GUI_Field[] makeGUIFields(){//make GUI board with the data from Gameboard
        ...
        gui_fields[2] = new GUI_Chance( "?","" ,"" , Color.BLACK, Color.WHITE );
        ...
        gui_fields[17] = new GUI_Chance( "?","" ,"" , Color.BLACK, Color.WHITE);
        ...
        gui_fields[22] = new GUI_Chance( "?","" ,"" , Color.BLACK, Color.WHITE );
        ...
        gui_fields[33] = new GUI_Chance( "?","" ,"" , Color.BLACK, Color.WHITE );
        ...
        gui_fields[36] = new GUI_Chance( "?","" ,"" , Color.BLACK, Color.WHITE);
